...
### 5. Avoid bundling unrelated refactors

Don't collapse multiple smell categories into one large refactor with no intermediate verification.
...
*Source: oh-my-codex/skills/ai-slop-cleaner/SKILL.md*
